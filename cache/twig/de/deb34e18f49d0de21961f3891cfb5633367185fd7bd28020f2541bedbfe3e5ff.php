...
/* README.md.twig */
class __TwigTemplate_b277be0a7988954df6adb25108ef1dd2b0255a7973bdfd35f4ea40451f6e80df extends Twig_Template
{
    ...
    {
        // line 1
        $context["component_title"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->inflectorFilter("title", $this->getAttribute((isset($context["component"]) ? $context["component"] : null), "name", array()));
        // line 2
        $context["component_hyphenated"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->inflectorFilter("hyphen", $this->getAttribute((isset($context["component"]) ? $context["component"] : null), "name", array()));
        // line 3
        $context["developer_hyphenated"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->inflectorFilter("hyphen", $this->getAttribute($this->getAttribute((isset($context["component"]) ? $context["component"] : null), "author", array()), "name", array()));
        // line 4
        echo "# ";
...
", "README.md.twig", "/Applications/MAMP/htdocs/ctms-grav/user/plugins/devtools/components/plugin/blank/README.md.twig");
    }
}
